...
export default function Tabview() {
  return (
      ...
      <Tab.Navigator tabBarLabel={false}>
        ...
        <Tab.Screen name="Home1" component={Home}  options ={{tabBarIcon : ({focused}) =>    focused ? <Image source={require('../../assets/images/gio1.png')}  style={{width: 18, height: 18}} /> : <Image source={require('../../assets/images/gio2.png')}  style={{width: 18, height: 18}} />, tabBarLabel: ''}} />
