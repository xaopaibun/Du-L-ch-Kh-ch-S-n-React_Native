...
export default function Tabview() {
  return (
      ...
      <Tab.Navigator tabBarLabel={false}>
        ...
        <Tab.Screen name="Home2" component={ScreenLogin}  options ={{tabBarIcon : ({focused}) =>   focused ? <Image source={require('../../assets/images/chuong1.png')}  style={{width: 18, height: 18}} />: <Image source={require('../../assets/images/chuong.png')}  style={{width: 18, height: 18}} />, tabBarLabel: ''}} />
