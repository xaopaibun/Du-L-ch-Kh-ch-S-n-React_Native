    ...
    return(
        <SafeAreaView style={{flex: 1, backgroundColor: '#ffffff'}}>
            ...
            <View style={{height: 40, alignItems: 'center', flexDirection:'row', paddingHorizontal: 16, justifyContent:'space-between', marginVertical: 10, backgroundColor: '#ffffff'}}>
                ...
                <TouchableOpacity onPress={() =>Alert.alert('Thông báo', 'Bạn đã lưu thành công')}><Text style={{color:'#FF5F24', fontSize: 12, fontWeight: '600'}}>Lưu</Text></TouchableOpacity>
            </View>
                ...
                <View  style={{flex: 4}}>
                    ...
                    <View style={{flex: 0.5, borderBottomColor: '#B9B9B9', borderBottomWidth: 0.2,justifyContent: 'space-around'}}>
                        <View style={{flexDirection: 'row', flex: 0.3}}>
                            ...
                            <View style={{flex: 0.7, borderBottomColor: '#B9B9B9', borderBottomWidth: 0.2}}><TextInput style={{paddingVertical: 10}} placeholder='Họ Tên' value = 'Phạm Jin'
                            /></View>
                        </View>
                        <View style={{flexDirection: 'row', flex: 0.3}}>
                            <View style={{flex: 0.3, justifyContent: 'center'}}><Text style={{color: '#555555'}}>Email</Text></View>
                            <View style={{flex: 0.7, borderBottomColor: '#B9B9B9', borderBottomWidth: 0.2}}><TextInput style={{paddingVertical: 10}} placeholder='Email' value = 'vanquy33338888@gmail.com'/></View>
                        </View>
                        <View style={{flexDirection: 'row', flex: 0.3}}>
