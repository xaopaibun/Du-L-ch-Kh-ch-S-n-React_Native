...
const renderItemNguoiTheoDoi = ({item}) =>{
    return(
        <View style={{flexDirection: 'row', justifyContent: 'space-between', borderBottomColor: '#B9B9B9', borderBottomWidth: 0.2, paddingVertical: 10}}>
            ...
            <View>
                <TouchableOpacity style={{justifyContent: 'center',backgroundColor: '#FF5F24',alignItems: 'center',height: 20, width: 75, borderColor: '#FF5F24', borderWidth: 1, borderRadius: 5}}>
                        <Text style={{color: 'white', fontSize: 10}}>Đang theo dõi</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
...
const NguoiDangTheoDoi = ({navigation}) =>{
    return(
        <SafeAreaView style={{flex: 1, backgroundColor: '#ffffff'}}>
             <View style={{height: 40, alignItems: 'center',flexDirection:'row', paddingHorizontal: 16, justifyContent:'space-between', marginVertical: 10, backgroundColor: '#ffffff'}}>
                ...
                <View><Text style={{fontSize: 14, fontWeight:'bold', color:'black'}}>Đang Theo Dõi</Text></View>
                <View></View>
            </View>
...
export default NguoiDangTheoDoi;