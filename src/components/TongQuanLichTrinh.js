      ...
      <View style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
        <ScrollView style={{ flex: 1, padding: 16 }}>
          <View style={{ alignItems: 'center', justifyContent: 'space-around', flex: 0.5 }}>
            ...
            <Text style={{ textAlign: 'center', color: 'rgba(130, 130, 130, 1)', fontSize: 12 }}>Chuyến bay: VJ345</Text>
          ...
          <View style={{ flex: 0.2 }}>
            <TouchableOpacity style={{
              shadowColor: "rgba(174, 174, 174, 0.3)",
              shadowOffset: {
                width: 0,
                height: 4,
              },
  ...
  const ThamQuan = () => {
    return (
      <View style={{ flex: 1, paddingHorizontal: 16, backgroundColor: '#E5E5E5' }}>
        <View style={{ flex: 0.9 }}>
          <View style={{ height: 86, flexDirection: 'row', padding: 16, backgroundColor: 'white', borderRadius: 5, marginVertical: 10 }}>
    ...
    <View style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
      ...
      <View style={{ flex: 1 }}>
        <Tab.Navigator tabBarOptions={
          ...
          <Tab.Screen name="LichNgay1FDSG" component={LichTrinh} options={{
            tabBarLabel: ({ focused }) =>
          ...
          <Tab.Screen name="LichNgay1FDSGEW" component={MayBay} options={{
            tabBarLabel: ({ focused }) =>
              <View style={{ marginHorizontal: 10, height: 30, width: 80, justifyContent: 'center', alignItems: 'center', backgroundColor: focused ? '#FF5F24' : '#ECF1FF', borderRadius: 5 }}>
          ...
          <Tab.Screen name="LichNgay1FDSG3" component={ChiTietKhachSan} options={{
            tabBarLabel: ({ focused }) =>
              <View style={{ marginHorizontal: 10, height: 30, width: 80, justifyContent: 'center', alignItems: 'center', backgroundColor: focused ? '#FF5F24' : '#ECF1FF', borderRadius: 5 }}>
          ...
          <Tab.Screen name="LichNgay1FDSG3de" component={ThamQuan} options={{
            tabBarLabel: ({ focused }) =>
              <View style={{ marginHorizontal: 10, height: 30, width: 80, justifyContent: 'center', alignItems: 'center', backgroundColor: focused ? '#FF5F24' : '#ECF1FF', borderRadius: 5 }}>
