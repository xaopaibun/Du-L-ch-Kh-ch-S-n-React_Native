...
const Home = ({ navigation }) => {
    ...
    const renderItemTraiNghiem = ({ item }) => (
        <TouchableOpacity onPress={() => navigation.navigate('ScreenChiTietKhamPha')} style={{ height: 250, width: 220, marginRight: 16, }}>
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#E5E5E5', position: 'relative' }}>
                    ...
                    Loading ?
                        ...
                        <View>
                            ...
                            <FlatList
                                ...
                                style={{ marginLeft: 16 }}
                            />
                            <View style={{ height: 30, marginHorizontal: 16, justifyContent: 'space-between', flexDirection: 'row', marginTop: 10 }}>
            ...
            <Draggable x={width - scale(70)} y={height - scale(150)} minX={scale(10)} minY={scale(51)} maxX={width - scale(10)} maxY={height - scale(95)}><Image source={require('../assets/images/Frame7.png')} style={{ width: scale(49), height: scale(49) }} /></Draggable>
        </View>
