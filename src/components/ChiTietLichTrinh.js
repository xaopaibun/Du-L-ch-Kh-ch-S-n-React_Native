                            ...
                            return (
                                <View key={item.id.toString()} style={{ marginTop: 9, height: 165, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ flex: 9.5, marginLeft: 12, justifyContent: 'space-around' }}>
                                        <Text>{item.gioxuatphat}</Text>
                                        <View style={{
                                            backgroundColor: 'white', borderRadius: 5, overflow: 'hidden', height: 80, flexDirection: 'row', justifyContent: 'flex-end', shadowColor: "#000",
                                            shadowOffset: {
                                                width: 0,
                                                height: 3,
                                            },
        ...
        <View style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
            ...
            <View style={{ flex: 1, paddingLeft: 16 }}>
                <Tab.Navigator tabBarOptions={
                    ...
                    <Tab.Screen name="LichNgay1" component={LichNgay1} options={{
                        tabBarLabel: ({ focused }) => <View style={{ alignItems: 'center' }}>
                    ...
                    <Tab.Screen name="LichNgay2" component={LichNgay1} options={{
                        tabBarLabel: ({ focused }) => <View style={{ alignItems: 'center' }}>
                    ...
                    <Tab.Screen name="LichNgay3" component={LichNgay1} options={{
                        tabBarLabel: ({ focused }) => <View style={{ alignItems: 'center' }}>
                    ...
                    <Tab.Screen name="LichNgay4" component={LichNgay1} options={{
                        tabBarLabel: ({ focused }) => <View style={{ alignItems: 'center' }}>
